...
page <- "http://cdec.water.ca.gov/reportapp/javareports?name=PAGE6"
...
date <- mdy(html_text(html_node(read_html(page),"h2 , h2")), format = yyyymmdd) #.h2 & pre Id'd by SelectorGadget
